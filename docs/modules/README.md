# Module documentation (eval)

Deep dives for modules claimed at 42 evaluation. Summary table: [README.md](../../README.md#modules-eval) · Planning: [EVAL_MODULES.md](../../EVAL_MODULES.md)

## Implemented modules (eval-ready) — 16 points

| Module | Pts | Document |
|--------|-----|----------|
| Web Major — Next.js + NestJS frameworks | 2 | [web-frameworks.md](./web-frameworks.md) |
| Web Major — WebSockets (real-time) | 2 | [websockets-realtime.md](./websockets-realtime.md) |

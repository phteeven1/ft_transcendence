  ...
  return (
    <>
      ...
      <Dialog
        open={showModal}
        onClose={handleClose}
        title={t('messageGroupModal.title')}
      ...
      >
        <p className="text-sm text-muted-foreground mb-4">
          {t('messageGroupModal.description', { groupName: group.name })}
        </p>
        ...
        <textarea
          ...
          rows={4}
          autoFocus
          placeholder={t('messageGroupModal.placeholder')}
          className="clay-input w-full resize-none text-sm mb-1"
        />
        <p className="text-xs text-muted-foreground text-right">
          {t('messageGroupModal.charCount', {

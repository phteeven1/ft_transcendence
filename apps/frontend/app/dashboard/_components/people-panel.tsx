...
import PeopleDialogs from './people-dialogs';
import { usePeoplePanel } from '../_hooks/use-people-panel';
      ...
      return [
        {
          ...
          icon: 'sign-out',
          onSelect: () => handleMemberAction('resign'),
        },
      ];
    }
    ...
    return [
      {
        ...
        icon: 'crown',
        onSelect: () => handleMemberAction('promote', member),
      },
      {
        id: 'expel',
        label: tCommon('expel'),
        icon: 'trash',
        onSelect: () => handleMemberAction('expel', member),
        destructive: true,
      },
    ];
  }
    ...
    return [
      {
        ...
        icon: 'pencil',
        onSelect: () => handlePlayerAction('rename', player),
      },
      {
        id: 'delete',
        label: tCommon('delete'),
        icon: 'trash',
        onSelect: () => handlePlayerAction('delete', player),
      },
    ];
  }
